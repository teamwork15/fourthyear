...
public ModelAndView add(Lecturer lec) {
    ...
    rest.postForObject("http://zuul-server/lecturer/save",lec,Lecturer.class);
...
public ModelAndView deleteLec(@RequestParam String lecturerId) {
	ModelAndView mv=new ModelAndView();
	rest.delete("http://zuul-server/lecturer/deletelecturer/" + lecturerId);
	MyLecturer lec=rest.getForObject("http://zuul-server/lecturer/getLecturers", MyLecturer.class);
